...
ROOMCREATE200RESPONSEPHASE_ANY_OF_SCHEMAS = ["str"]

class RoomCreate200ResponsePhase(BaseModel):
    """
    RoomCreate200ResponsePhase
    """
    ...
    any_of_schemas: List[str] = Literal[ROOMCREATE200RESPONSEPHASE_ANY_OF_SCHEMAS]
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = RoomCreate200ResponsePhase.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in RoomCreate200ResponsePhase with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into RoomCreate200ResponsePhase with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance
