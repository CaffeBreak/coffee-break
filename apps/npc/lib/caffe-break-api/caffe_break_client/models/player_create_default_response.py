...
class PlayerCreateDefaultResponse(BaseModel):
    """
    PlayerCreateDefaultResponse
    """ # noqa: E501
    message: StrictStr
    code: StrictStr
    issues: Optional[List[PlayerCreateDefaultResponseIssuesInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "issues": [PlayerCreateDefaultResponseIssuesInner.from_dict(_item) for _item in obj.get("issues")] if obj.get("issues") is not None else None
        })
        return _obj
