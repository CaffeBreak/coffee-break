...
class RoomCreateRequest(BaseModel):
    ...
    RoomCreateRequest
    """ # noqa: E501
    player_id: Annotated[str, Field(strict=True)] = Field(alias="playerId")
    password: Annotated[str, Field(strict=True)]
    __properties: ClassVar[List[str]] = ["playerId", "password"]

    @field_validator('player_id')
    def player_id_validate_regular_expression(cls, value):
